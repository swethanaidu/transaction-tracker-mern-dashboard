...
const CustomDailogTransactionForm = ({ open, handleClose, debtData, title , isLoading, usersList, ecList, vendorsList, bankList}) => {
...
export default CustomDailogTransactionForm;
